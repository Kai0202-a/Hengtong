  ...
  const handleLogin = async () => {
    try {
      ...
      if (username.startsWith("admin")) {
        url = "https://hengtong-515b4uhyv-kais-projects-975b317e.vercel.app/api/admin/login";
        role = "admin";
      } else {
        url = "https://hengtong-515b4uhyv-kais-projects-975b317e.vercel.app/api/dealer/login";
        role = "dealer";
      }
